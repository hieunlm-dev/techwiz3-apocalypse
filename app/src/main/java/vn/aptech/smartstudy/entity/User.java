...
public class User {
    ...
    public User(int id, String full_name, String phone_number, String email, String address, String password, String role, Boolean isEnabled, TeacherData teacherData) {
        this.id = id;
